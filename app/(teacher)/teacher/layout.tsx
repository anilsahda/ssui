        ...
        <aside className="d-flex flex-column p-3 shadow-sm" style={{ width: 230, background: "linear-gradient(180deg, #1e293b, #0f172a)", color: "#f1f5f9" }}>
          <nav>
            <ul className="nav nav-pills flex-column gap-1">
              <li>
                <Link href="/teacher" className="nav-link d-flex align-items-center gap-2 sidebar-link active">
                  <MdDashboard size={18} className="text-info" /> Dashboard
                </Link>
              </li>
              <li>
                <Link href="/teacher/item1" className="nav-link d-flex align-items-center gap-2 sidebar-link">
