          ...
          <nav>
            <ul className="nav nav-pills flex-column gap-1">
              ...
              <li>
                ...
                >
                  <FaBuilding size={18} className="text-primary" /> Company
                  Profile
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link
                  ...
                  className="nav-link d-flex align-items-center gap-2 sidebar-link"
                >
                  <HiOutlineClipboardList size={18} className="text-warning" />{" "}
                  Posted Jobs
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="nav-link d-flex align-items-center gap-2 sidebar-link"
                >
                  <RiProfileLine size={18} className="text-danger" /> Profile
                  Match
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="nav-link d-flex align-items-center gap-2 sidebar-link"
                >
                  <TbChecklist size={18} className="text-secondary" /> Applied
                  Jobs
                </Link>
              </li>
            </ul>
